...
const MainPage =  () =>{
    ...
    return (
		...
		<div id="about" >
			...
			<Container className="mt-5 d-flex flex-row about_info">
		...
		<div style={{marginTop:'100px'}} id="program">
		...
		<p className="header" id="cost">СТОИМОСТЬ</p>
